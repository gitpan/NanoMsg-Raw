...
=head2 nn_socket($domain, $protocol)
...
=head2 nn_setsockopt($s, $level, $option, $value)
...
=head2 nn_getsockopt($s, $level, $option)
...
=head2 nn_recv($s, $data, $length=NN_MSG, $flags=0)
...
=head2 nn_sendmsg($s, $flags, $data1, $data2, ..., $dataN)
...
=head2 nn_recvmsg($s, $flags, $data1 => $len1, $data2 => $len2, ..., $dataN => $lenN)
